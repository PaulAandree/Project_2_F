...
# Read the data
Int_movil = pd.read_csv(r'E:\GITHUB\Project_2_F\data\Ingresos_Internet_Movil_CD.csv')
Int_fijo = pd.read_csv(r'E:\GITHUB\Project_2_F\data\Ingresos_Internet_Fijo_CD.csv')
